...
### v0.6.0 - Agent Quality Optimization (2026-06-28)
- **Router准确率**: 95% → 99.0% (+4.2%)
- **幻觉率**: 27.5% → 8.0% (-70.9%)
- **引用完整性**: 85% → 96.0% (+12.9%)
- **零破坏性变更**: 100%向后兼容

📖 [完整发布说明](releases/RELEASE_NOTES_v0.6.0.md) | 🚀 [部署指南](DEPLOYMENT_GUIDE_v0.6.0.md)
...
### 🚀 版本发布
- [v0.6.0 发布说明](releases/RELEASE_NOTES_v0.6.0.md) ⭐ NEW - Agent质量优化
- [v0.6.0 部署指南](DEPLOYMENT_GUIDE_v0.6.0.md) - 完整部署说明
- [v0.5.0 发布说明](releases/RELEASE_NOTES_v0.5.0.md) - 权限系统
