...
const initialNodes: Node[] = [
  ...
  { id: '9', type: 'default', data: { label: '' }, position: { x: 100, y: 980 }, className: 'node-agent' },
  { id: '10', type: 'default', data: { label: '' }, position: { x: 350, y: 980 }, className: 'node-agent' },
  { id: '11', type: 'default', data: { label: '' }, position: { x: 600, y: 980 }, className: 'node-agent' },
  { id: '12', type: 'default', data: { label: '' }, position: { x: 850, y: 980 }, className: 'node-agent' },
  { id: '13', type: 'default', data: { label: '' }, position: { x: 50, y: 1180 }, className: 'node-retrieval' },
  { id: '14', type: 'default', data: { label: '' }, position: { x: 280, y: 1180 }, className: 'node-retrieval' },
  { id: '15', type: 'default', data: { label: '' }, position: { x: 510, y: 1180 }, className: 'node-retrieval' },
  { id: '16', type: 'default', data: { label: '' }, position: { x: 740, y: 1180 }, className: 'node-retrieval' },
  { id: '17', type: 'default', data: { label: '' }, position: { x: 300, y: 1360 }, className: 'node-output' },
  { id: '18', type: 'default', data: { label: '' }, position: { x: 150, y: 1500 }, className: 'node-output' },
  { id: '19', type: 'default', data: { label: '' }, position: { x: 450, y: 1500 }, className: 'node-output' },
  { id: '20', type: 'default', data: { label: '' }, position: { x: 750, y: 1500 }, className: 'node-output' },
  { id: '21', type: 'default', data: { label: '' }, position: { x: 1100, y: 1180 }, className: 'node-validation' },
  { id: '22', type: 'default', data: { label: '' }, position: { x: 1100, y: 820 }, className: 'node-validation' },
  { id: '23', type: 'default', data: { label: '' }, position: { x: 1100, y: 540 }, className: 'node-validation' },
  { id: '24', type: 'default', data: { label: '' }, position: { x: 1100, y: 680 }, className: 'node-validation' },
  { id: '25', type: 'default', data: { label: '' }, position: { x: 1100, y: 980 }, className: 'node-retrieval' },
  { id: '26', type: 'default', data: { label: '' }, position: { x: 1100, y: 260 }, className: 'node-auth' },
  { id: '27', type: 'default', data: { label: '' }, position: { x: 1100, y: 1360 }, className: 'node-validation' },
  { id: '28', type: 'default', data: { label: '' }, position: { x: 970, y: 1180 }, className: 'node-retrieval' },
];
