...
# under MULTILINE (python:S8786). `[ \t][^\n]+` is the same language as the
# `[ \t]+[^\n]+` it replaced -- the extra spaces are simply part of the rest of
# the line -- without two adjacent quantifiers competing for the same spaces.
