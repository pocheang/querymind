...
| 模型提供商 | 支持模型 | 用途 |
|-----------|---------|------|
| **OpenAI** | GPT-4o, GPT-4o-mini, GPT-4-Turbo, o1-preview | 云端 API，高性能推理 |
| **Anthropic** | Claude 3.5 Sonnet, Claude 3 Opus/Haiku | 高质量长文本推理 |
| **Google** | Gemini 2.0 Flash, Gemini 1.5 Pro | 多模态理解 |
| **DeepSeek** | DeepSeek-V3, DeepSeek-Coder-V2 | 高性价比推理，代码生成 |
| **Ollama** | Llama 3.1/3.2, Qwen2.5, DeepSeek-R1 | 本地部署，隐私保护 |
| **OpenRouter** | 200+ 模型统一接口 | 模型聚合平台 |
...
```bash
# GPT-4o 系列（最新推荐）
export LLM_MODEL="gpt-4o"           # 最强多模态模型
export LLM_MODEL="gpt-4o-mini"      # 高性价比版本
export LLM_MODEL="gpt-4-turbo"      # 快速版本

# GPT-4 经典系列
export LLM_MODEL="gpt-4"            # 标准版本
export LLM_MODEL="gpt-3.5-turbo"    # 经济版本

# o1 推理系列（复杂推理）
export LLM_MODEL="o1-preview"       # 高级推理
export LLM_MODEL="o1-mini"          # 快速推理
```

**Anthropic Claude**:
```bash
# Claude 3.5 系列（最新推荐）
export LLM_MODEL="claude-3-5-sonnet-20241022"  # 平衡性能
export LLM_MODEL="claude-3-5-haiku-20241022"   # 快速响应

# Claude 3 经典系列
export LLM_MODEL="claude-3-opus-20240229"      # 最强能力
export LLM_MODEL="claude-3-sonnet-20240229"    # 标准版本
export LLM_MODEL="claude-3-haiku-20240307"     # 经济版本
```

**Google Gemini**:
```bash
# Gemini 2.0 系列（最新）
export LLM_MODEL="gemini-2.0-flash-exp"        # 快速实验版
export LLM_MODEL="gemini-1.5-pro"              # 专业版本
export LLM_MODEL="gemini-1.5-flash"            # 快速版本
```

**DeepSeek**:
```bash
# DeepSeek V3（高性价比）
export LLM_MODEL="deepseek-chat"               # DeepSeek-V3
export LLM_MODEL="deepseek-coder"              # 代码专用模型
export LLM_MODEL="deepseek-reasoner"           # DeepSeek-R1 推理
```
...
# Meta Llama 系列
ollama pull llama3.2              # Llama 3.2 (最新)
ollama pull llama3.1              # Llama 3.1
ollama pull llama3.1:70b          # 大型版本

# 阿里 Qwen 系列（中文优化）
ollama pull qwen2.5:72b           # Qwen 2.5 大型版本
ollama pull qwen2.5:32b           # Qwen 2.5 中型版本
ollama pull qwen2.5:7b            # Qwen 2.5 小型版本
ollama pull qwen2.5-coder         # 代码专用

# DeepSeek 开源系列
ollama pull deepseek-r1:70b       # DeepSeek-R1 (推理模型)
...
# Google Gemma 系列
ollama pull gemma2:27b            # Gemma 2 大型版本
ollama pull gemma2:9b             # Gemma 2 中型版本
```
...
| 场景 | 推荐模型 | 原因 |
|------|---------|------|
| **生产环境（云端）** | GPT-4o, Claude 3.5 Sonnet | 性能强大，稳定可靠 |
| **高性价比** | DeepSeek-V3, GPT-4o-mini | 成本低，性能优秀 |
| **中文优化** | Qwen2.5, DeepSeek-V3 | 中文理解能力强 |
| **代码生成** | DeepSeek-Coder, GPT-4o | 代码能力突出 |
| **本地部署** | Qwen2.5:32b, Llama3.2 | 隐私保护，离线可用 |
| **长文本处理** | Claude 3.5, Gemini 1.5 Pro | 上下文窗口大 |
| **复杂推理** | o1-preview, DeepSeek-R1 | 推理能力强 |
# 安装 Ollama
