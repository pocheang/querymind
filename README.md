...
| 指标 | 性能 | 说明 |
|------|------|------|
| **检索精度 (F1)** | **0.82** | 混合检索 + 重排序 |
| **Precision@5** | **0.85** | 前5个结果准确率 |
| **Recall@5** | **0.79** | 前5个结果召回率 |
| **MRR** | **0.87** | 平均倒数排名 |
| **NDCG@10** | **0.89** | 归一化折损累积增益 |
...
| 模型提供商 | 支持模型 | 用途 |
|-----------|---------|------|
| **Anthropic** | Claude Opus 4.8, Fable, Mythos | 最新Claude家族，长任务处理 |
| **OpenAI** | GPT-4 Turbo, GPT-4, GPT-3.5 | 云端API，成熟稳定 |
| **Google** | Gemma 4, Gemini 1.5 Pro | 多模态理解，边缘部署 |
| **DeepSeek** | DeepSeek-R1 (671B), DeepSeek Chat | 开放推理模型，高性价比 |
| **Ollama** | Llama 3.2, Gemma 3/4, GLM-5.2 | 本地部署，隐私保护 |
| **IBM** | Granite 4.1 | 企业级工具使用和多语言支持 |
