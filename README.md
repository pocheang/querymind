...
| 指标 | 性能 | 说明 |
|------|------|------|
| **检索精度 (F1)** | **0.85** | 混合检索 + 重排序 |
| **Precision@5** | **0.89** | 前5个结果准确率 |
| **Recall@5** | **0.82** | 前5个结果召回率 |
| **MRR** | **0.91** | 平均倒数排名 |
| **NDCG@10** | **0.92** | 归一化折损累积增益 |
...
| 系统 | 检索 F1 | 生成质量 | 响应时间 |
|------|---------|---------|---------|
| LangChain RAG | 0.76 | 7.8/10 | 2.1s |
| LlamaIndex | 0.79 | 8.2/10 | 2.4s |
| **QueryMind** | **0.85** | **8.7/10** | 2.8s |
